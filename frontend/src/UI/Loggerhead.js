...
const Loggerhead = () => {
  ...
  return (
    <div>
       ...
       <h3>Introduction</h3>
       <p>Loggerheads may grow to be 1 metre long and weigh up to 180 kilograms. 
        This species nests on tropical beaches as well as beaches in temperate areas like as the Mediterranean and the United States' south-east coast.
         ...
         It is thus critical to adopt prompt conservation efforts to safeguard the Loggerhead turtles in Sri Lanka. Loggerhead turtles are predominantly carnivorous, eating mollusks and crustaceans.
          The term ''Loggerhead'' alludes to the huge head that houses a massive, muscular set set of jaws, ideal for crushing mollusks and crustaceans. Loggerhead turtles are now considered as ‘’Endangered’. </p>
